...
searchloc = ['서울 강남구 주차장', '서울 강동구 주차장', '서울 종로구 주차장', '서울 중구 주차장', '서울 용산구 주차장', '서울 성동구 주차장', '서울 광진구 주차장', '서울 동대문구 주차장', '서울 중랑구 주차장', '서울 성북구 주차장', '서울 강북구 주차장', '서울 도봉구 주차장', '서울 노원구 주차장', '서울 은평구 주차장', '서울 서대문구 주차장', '서울 마포구 주차장', '서울 양천구 주차장', '서울 강서구 주차장', '서울 구로구 주차장', '서울 금천구 주차장', '서울 영등포구 주차장', '서울 동작구 주차장', '서울 관악구 주차장', '서울 서초구 주차장', '서울 송파구 주차장']
...
for loc in searchloc:
    ...
    def storeNamePrint(page):
        ...
        if page == 1:
            with open('D:/대학교/2024-1학기/심화캡스톤/Crawling/주차장 크롤링/store_list_{}.csv'.format(loc), 'w', encoding='utf-8-sig', newline='') as f:
            ...
            with open('D:/대학교/2024-1학기/심화캡스톤/Crawling/주차장 크롤링/store_list_{}.csv'.format(loc), 'a', encoding='utf-8-sig', newline='') as f:
                writercsv = csv.writer(f)
